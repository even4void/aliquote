...
I'm a middle-aged bohemian scientist, initially trained in cognitive science before working as a medical statistician for nearly a decade. I also happened to be a teacher for 15 years when time allowed, while pretending to be an applied statistician the rest of the week. Professional details were once available on a "[publish-or-perish](/pubpwr)" page, which is no longer up to date. There's a [now](/now) page instead, which I update occasionally. But let that not stop you reading more.

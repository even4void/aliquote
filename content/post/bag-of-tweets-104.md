...
- 2018-11-02 @iamtrask: I recently wrote a book teaching Deep Learning - it's goal is to be the easiest intro possible In the book, each lesson builds a neural component _from scratch_ in #NumPy Each _from scratch_ toy code example is in the Github below. #100daysofMLcode https://t.co/3KEfLNjvj5 https://t.co/Rv8yk9mKOx
...
- 2018-11-16 @JosephineLukito: Text analysis is way easier to learn when you are (1) guided by a good tutorial (or tutor) and (2) when you are interested in your data. In this blog post, I list several tutorials on the beloved #tidytext package in R. https://t.co/30dLRv5L0s 1/2

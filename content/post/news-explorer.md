...
News Explorer fulfills all the above requirements and let me replicate my
actual workflow when using Newsboat. And it is somewhat faster! I didn't check
if my feeds are perfectly synced between my MacBook and my iPhone, and I
limited the iCloud storage to two weeks. I'll keep managing my permanent
archives with Newsboat (storing plain text data in a SQLite database is cheap).
Behind the scene, News Explorer relies on snapshots which allow to reduce the
...
{{< fluid_imgs
"pure-u-1-2|/img/2026-08-20-11-05-03.png"
"pure-u-1-2|/img/2026-08-20-11-11-20.png" >}}
...
connect the iOS app to the iCloud database. I ran into trouble running the
other way around.

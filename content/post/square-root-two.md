...
$$ p*{n+1}^2 - 2q*{n+1}^2 = -(p_n^2 - 2q_n^2) = \dots = (-1)^{n+1}(p_0^2 - 2q_0^2), $$

which implies that:

$$ \frac{p*{n+1}}{q*{n+1}} - 2^{1/2} = \frac{(-1)^{n+1}(p*0^2 - 2q_0^2)}{q*{n+1}(p*{n+1}+2^{1/2}q*{n+1})}. $$
...
$$ \left| \frac{p*n}{q_n} - 2^{1/2} \right| < \frac{1}{2} \left| \frac{p_n}{q_n} - \frac{p*{n-1}}{q\_{n-1}} \right|, $$
...
$$ p*{in+1} = \sum*{j=1}^k c*{ij}p*{jn}, \qquad i = 1, 2, \dots, k;\quad n = 0, 1, 2, \dots $$
